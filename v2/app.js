...
app.post("/cable/:id/cluch",function(req,res){
...
app.post("/cable/:id/break",function(req,res){
    var peaceNo=req.body.peaces;
    bike.findById(req.params.id,function(err,bike){
...
app.post("/cable/:id/accelator",function(req,res){
    var peaceNo=req.body.peaces;
    bike.findById(req.params.id,function(err,bike){
...
app.post("/cable/:id/meter",function(req,res){
    var peaceNo=req.body.peaces;
    bike.findById(req.params.id,function(err,bike){
...
app.post("/wishlist/:id/cluch",function(req,res){
    var peaceNo=req.body.peaces;
    bike.findById(req.params.id,function(err,bike){
        var model=bike.model_name + " Cluch Cable";
        var price=bike.cluch_price;
...
app.post("/wishlist/:id/break",function(req,res){
    var peaceNo=req.body.peaces;
    bike.findById(req.params.id,function(err,bike){
        var model=bike.model_name + " Break Cable";
        var price=bike.cluch_price;
...
app.post("/wishlist/:id/accelator",function(req,res){
    var peaceNo=req.body.peaces;
    bike.findById(req.params.id,function(err,bike){
        var model=bike.model_name + " Accelator Cable";
        var price=bike.cluch_price;
...
app.post("/wishlist/:id/meter",function(req,res){
    var peaceNo=req.body.peaces;
    bike.findById(req.params.id,function(err,bike){
        var model=bike.model_name + " Meter Cable";
        var price=bike.cluch_price;
...
app.post("/indicator/cart/:id",function(req,res){
    var peaceNo=req.body.peaces;
...
app.post("/indicator/wishlist/:id",function(req,res){
    var peaceNo=req.body.peaces;
    indicator.findById(req.params.id,function(err,indicator){
        var model=indicator.model_name + " Indicator";
        var price=indicator.indicator_price;
